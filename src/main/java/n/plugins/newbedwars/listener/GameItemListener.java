...
public class GameItemListener implements Listener {
    ...
    private ConfigurationSection cachedItemsSection;
    private long itemsSectionCacheTime;
    ...
    private ConfigurationSection findRewardSection(ItemStack item, String field, String expectedValue) {
        ...
        if (cachedItemsSection == null || now - itemsSectionCacheTime > 5000L) {
            cachedItemsSection = plugin.getConfig().getConfigurationSection("item-shop.items");
            itemsSectionCacheTime = now;
        }
        ConfigurationSection items = cachedItemsSection;
        if (items == null) {
            return null;
        }
